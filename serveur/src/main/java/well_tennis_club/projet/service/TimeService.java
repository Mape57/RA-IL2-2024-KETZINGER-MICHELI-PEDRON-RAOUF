...
import well_tennis_club.projet.repository.TimeRepository;
...
public class TimeService {
	...
	public TimeEntity createTime(TimeEntity time) {
		return timeRepository.save(time);
	}

	public TimeEntity updateTime(TimeEntity time) {
		return timeRepository.save(time);
	}
	...
	public TimeEntity getTimeById(UUID id) {
