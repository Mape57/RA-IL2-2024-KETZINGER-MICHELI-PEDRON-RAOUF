...
import well_tennis_club.projet.dto.TimeCourtDto;
import well_tennis_club.projet.entity.TimeCourtEntity;
import well_tennis_club.projet.key.TimeCourtKey;
import well_tennis_club.projet.mapper.TimeCourtMapper;
...
public class TimeCourtController {
	...
	@Autowired
	public TimeCourtController(TimeCourtService timeCourtService) {
		this.timeCourtService = timeCourtService;
	}
