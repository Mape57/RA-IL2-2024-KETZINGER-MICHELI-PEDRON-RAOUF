...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(ConnectionService connectionService,JwtUtils jwtUtils){this.connectionService = connectionService;this.jwtUtils = jwtUtils;}
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/openapi/v3/api-docs/**", "/openapi/swagger-ui/**","/ws/**","/auth/*").permitAll()
