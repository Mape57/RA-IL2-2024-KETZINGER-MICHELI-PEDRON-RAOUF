 ...
 */
public record TrainerSessionOverlappingJustification(Session sessionA, Session sessionB, HardSoftScore score, String description) implements ConstraintJustification {
