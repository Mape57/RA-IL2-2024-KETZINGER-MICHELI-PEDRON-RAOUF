 ...
 */
public record TrainerAvailabilityJustification(Session session, Integer sessionDuration, HardSoftScore score, String description) implements ConstraintJustification {
